-- Strict Email Verification Migration
-- 1. Defer profile creation until email_confirmed_at is NOT NULL
...
-- 2. Drop existing check_account_status function before creating new signature
...
returns table (has_account boolean, is_admin boolean, is_unconfirmed boolean)
language sql
security definer
